...
const included = [
  "Loading, hauling & disposal fees included",
  "Area swept clean after removal",
  "Same/next-day service when available",
  "Eco-friendly: we donate & recycle",
];
    ...
    <section id="pricing" className="py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-14 bg-white rounded-2xl p-8 shadow-md border border-gray-100"
        >
          <h3 className="font-bold text-lg text-primary-dark mb-4 text-center">Always Included</h3>
